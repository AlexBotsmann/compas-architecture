...
Було проведено первинне опитування, щоб визначити деякі технології, які ми могли б використати:

| Технологія                     | Назва технології | Переваги | Виклики | Еталонний проект | Думка Роба | Думка RTE | Думка GE  |
| ------------------------------ |:---------------:| -------:| ----------:| -----------------:| -------:| ----------------------:|----------------------------------------------------------:|
